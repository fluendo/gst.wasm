 ...
 */
 ...
 #include "tools.h"
 //#include <gst/gst_private.h>    /* for internal Factories */ //Modified by me
 #include "gst_private.h"    /* for internal Factories */
 ...
 real_main (int argc, char *argv[])
 {
   ...
   g_option_context_add_main_entries (ctx, options, NULL); //Modified by me
