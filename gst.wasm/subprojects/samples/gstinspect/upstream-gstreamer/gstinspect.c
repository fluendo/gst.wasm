/* 
  *** TAKEN FROM UPSTREAM GSTREAMER AND TAILORED FOR GST-WASM ***
 ...
 */
 ...
 #include "upstream-gstreamer/tools.h"
 //#include <gst/gst_private.h>    /* for internal Factories */ //Modified from upstream-gstreamer
 #include "upstream-gstreamer/gst_private.h"    /* for internal Factories */
 ...
 //#include "gst/glib-compat-private.h" //Modfied by me
 #include "upstream-gstreamer/glib-compat-private.h"
 ...
 gboolean colored_output = FALSE; //Added by me
 ...
 print_element_list (gboolean print_all, gchar * ftypes)
 {
  ...
  //  if (sort_output == SORT_TYPE_NAME) //Modified from upstream-gstreamer (breaks silently)
 ...
 real_main (int argc, char *argv[])
 {
   ...
   //g_set_prgname ("gst-inspect-1.0");  //Modified from upstream-gstreamer

 #ifndef GST_DISABLE_OPTION_PARSING
   ctx = g_option_context_new ("[ELEMENT-NAME | PLUGIN-NAME]");
   g_option_context_add_main_entries (ctx, options, NULL); //Modified from upstream-gstreamer
